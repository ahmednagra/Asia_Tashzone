...
export function SearchField({ value, onChangeText, placeholder, label }: { value: string; onChangeText: (t: string) => void; placeholder: string; label: string }) {
  const { c, t } = useTheme();
  return (
    <View style={[s.box, { borderRadius: t.shape.radius, borderColor: c.borderControl, backgroundColor: c.surface }]}>
...
const s = StyleSheet.create({
  box: { borderWidth: 1, minHeight: minTouchTarget, justifyContent: "center", paddingHorizontal: 14 },
