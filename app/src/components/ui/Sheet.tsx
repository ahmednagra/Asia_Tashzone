...
export function Sheet({ visible, title, onClose, children, actions }: { visible: boolean; title: string; onClose: () => void; children?: React.ReactNode; actions?: React.ReactNode }) {
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose} statusBarTranslucent>
      ...
      <View style={[s.sheet, { backgroundColor: t.sheet.bg, borderColor: t.sheet.border, borderWidth: t.surface.kind === "slab" ? 2 : 1, borderTopLeftRadius: t.shape.sheet, borderTopRightRadius: t.shape.sheet, paddingBottom: inset.bottom + 16 }, wide && s.wide]}>
