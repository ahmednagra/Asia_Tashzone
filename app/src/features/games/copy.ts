...
export const T = localized("games", {
  en: {
    ...
    detail: {
      ...
      notFound: "Game not found", notFoundBody: "This game isn't in the catalogue. It may have been renamed or removed.", back: "Back to games",
  ...
  ur: {
    ...
    games: {
      ...
      emptyTitle: (q: string) => `"${q}" نام کا کچھ نہیں ملا`, emptyHint: "مقامی نام آزمائیں: رنگ، ٹھلا، سویپ۔", showAll: "سب دکھائیں",
      emptyFilterTitle: "یہاں ابھی کوئی کھیل نہیں", emptyFilterHint: "اس فلٹر سے کچھ نہیں ملا۔",
      inDev: "تیاری میں",
    },
    detail: {
      rules: "قوانین", tags: "خصوصیات", play: "کھیلیں", soon: "جلد آ رہا ہے", soonNote: "ابھی تیاری میں ہے، بانٹا نہیں جا سکتا۔",
      notFound: "کھیل نہیں ملا", notFoundBody: "یہ کھیل فہرست میں نہیں۔ شاید اس کا نام بدلا گیا یا اسے ہٹا دیا گیا۔", back: "کھیلوں پر واپس",
      players: (a: string) => `${a} کھلاڑی`, pick: "اس کھیل کے قوانین ابھی لکھے جا رہے ہیں۔",
      aka: "دوسرا نام",
    },
    ways: {
      title: "کھیلنے کے طریقے", rules: "قوانین",
      bots: { t: "بوٹس کے ساتھ", d: "آف لائن · ہر چال کے بعد محفوظ", b: "آف لائن" },
      pass: { t: "باری باری", d: "ایک فون، ہاتھوں ہاتھ", b: "ایک فون" },
      wifi: { t: "ایک ہی Wi-Fi", d: "ایک نیٹ ورک پر دوستوں کے لیے میز بنائیں", b: "انٹرنیٹ نہیں" },
    ...
    setup: {
      ...
      levels: [
        ...
        { id: "medium", label: "درمیانہ", hint: "خالی سوٹ پہچانتا ہے، بڑے پتے بچا کر رکھتا ہے۔" },
        { id: "hard", label: "ماہر", hint: "ہر پتا گنتا ہے اور جال ڈھونڈتا ہے۔" },
      ],
    },
  },
  hi: {
    ...
    games: {
      ...
      emptyTitle: (q: string) => `“${q}” नाम का कुछ नहीं मिला`, emptyHint: "स्थानीय नाम आज़माएँ: रंग, ठुल्ला, स्वीप।", showAll: "सब दिखाएँ",
      emptyFilterTitle: "यहाँ अभी कोई खेल नहीं", emptyFilterHint: "इस फ़िल्टर से कुछ नहीं मिला।",
      inDev: "तैयार हो रहा है",
    },
    detail: {
      rules: "नियम", tags: "ख़ासियतें", play: "खेलें", soon: "जल्द आ रहा है", soonNote: "अभी तैयार हो रहा है, बाँटा नहीं जा सकता।",
      notFound: "खेल नहीं मिला", notFoundBody: "यह खेल सूची में नहीं है। शायद इसका नाम बदला गया या इसे हटा दिया गया।", back: "खेलों पर लौटें",
      players: (a: string) => `${a} खिलाड़ी`, pick: "इस खेल के नियम अभी लिखे जा रहे हैं।",
      aka: "दूसरा नाम",
    },
    ways: {
      title: "खेलने के तरीके", rules: "नियम",
      bots: { t: "बॉट्स के साथ", d: "ऑफ़लाइन · हर चाल के बाद सेव", b: "ऑफ़लाइन" },
      pass: { t: "बारी-बारी", d: "एक फ़ोन, हाथों-हाथ", b: "एक फ़ोन" },
      wifi: { t: "एक ही Wi-Fi", d: "एक नेटवर्क पर दोस्तों के लिए टेबल बनाएँ", b: "बिना इंटरनेट" },
    ...
    setup: {
      ...
      levels: [
        ...
        { id: "medium", label: "मध्यम", hint: "खाली सूट पहचानता है, बड़े पत्ते बचाकर रखता है।" },
        { id: "hard", label: "माहिर", hint: "हर पत्ता गिनता है और जाल ढूँढता है।" },
      ],
    },
  },
  ne: {
    ...
    games: {
      ...
      emptyTitle: (q: string) => `“${q}” नामको केही भेटिएन`, emptyHint: "स्थानीय नाम खोज्नुहोस्: रङ, ठुल्ला, स्विप।", showAll: "सबै देखाउनुहोस्",
    ...
    detail: {
      ...
      notFound: "खेल भेटिएन", notFoundBody: "यो खेल सूचीमा छैन। यसको नाम फेरिएको वा हटाइएको हुन सक्छ।", back: "खेलहरूमा फर्कनुहोस्",
      players: (a: string) => `${a} खेलाडी`, pick: "यो खेलका नियम अझै लेखिँदैछन्।",
      aka: "अर्को नाम",
    },
    ways: {
      title: "खेल्ने तरिका", rules: "नियम",
      bots: { t: "बटसँग खेल्ने", d: "अफलाइन · हरेक चालपछि सुरक्षित", b: "अफलाइन" },
    ...
    setup: {
      ...
      levels: [
        { id: "easy", label: "सजिलो", hint: "सही पत्ती खेल्छ, टेबल सम्झँदैन।" },
