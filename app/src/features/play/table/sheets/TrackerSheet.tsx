...
const s = StyleSheet.create({
  ...
  chip: { width: 24, height: 30, borderRadius: 5, backgroundColor: cards.face, alignItems: "center", justifyContent: "center" },
  glyph: { fontSize: 17 },
  ...
  rank: { fontFamily: fonts.cardIndex.family, fontSize: 13 },
