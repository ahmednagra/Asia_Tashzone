...
export function WelcomeScreen() {
  ...
  return (
    <Screen scroll={false} style={{ justifyContent: "center", alignItems: "center" }}>
      ...
      <Text accessibilityRole="header" style={[s.word, { color: t.accent.color, fontFamily: t.type.display, letterSpacing: t.type.tracking, textTransform: t.type.titleCase, fontSize: t.type.titleCase === "uppercase" ? 36 : 44 }]}>TashZone</Text>
      ...
      <View style={s.btns}>
        ...
        {profile.onboarded && profile.name ? <GoldButton kind="glass" label={T.continueAs(profile.name)} onPress={() => router.replace("/")} /> : null}
      </View>
      <View style={{ marginTop: 10 }}><Caption size={13}>{T.privacy}</Caption></View>
    </Screen>
  );
}
const s = StyleSheet.create({
  ...
  rank: { fontFamily: fonts.cardIndex.family, fontSize: 18 },
