...
No purple or pink anywhere. Legal-card emphasis is drawn **on the felt around the card** (gold `#E8C36A`, 7.4 dark / 6.0 light), never as a tint on the card face (gold on the face measures 1.6).
...
Scale (pt): 32 display · 24 H1 · 20 H2 · 17 body · 15 secondary · 13 caption; Nastaliq sizes +2 pt and line height 1.8. Fonts are downloaded per locale (platform §3); fallback system fonts render until loaded. Font families are chosen in the mockup phase (PD-03).
...
| PD-03 | Font families per script | choose in mockups with Nastaliq rendering check | mockups |
